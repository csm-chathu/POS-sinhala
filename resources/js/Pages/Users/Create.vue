    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-xl font-bold text-gray-800">{{ t('page.new_user') }}</h1>
            </div>
        </template>
        ...
        <div class="max-w-lg">
            <form @submit.prevent="submit" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ t('usr.password') }} <span class="text-red-500">*</span></label>
                    <div class="relative">
                        <input
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ t('usr.password_confirm') }} <span class="text-red-500">*</span></label>
                    <input
